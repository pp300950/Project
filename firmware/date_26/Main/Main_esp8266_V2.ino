...
.badge.s3   {background:#2d0f5e;color:#bc8cff}
...
function load(){
  fetch('/api/status').then(r=>r.json()).then(d=>{
    ...
    // Summary
    var total=d.z1_count+d.z2_count+d.z3_count;
    ...
    rows+=zoneRow(d.z2_name,d.z2_count,d.z2_last,'pool');
    rows+=zoneRow(d.z3_name,d.z3_count,d.z3_last,'s3');
