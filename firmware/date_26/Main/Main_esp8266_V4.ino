...
sendLine("🟢 SmartGuard พร้อมทำงานแล้ว\n"
         "━━━━━━━━━━━━━━━\n"
         "📡 ค่าเซนเซอร์ปัจจุบัน\n"
         "📌 " + String(zone1Name) + ": " + (b1 > 0 ? String(b1, 1) + " cm" : "ไม่มีสัญญาณ") + "\n"
         "📌 " + String(zone2Name) + ": " + (b2 > 0 ? String(b2, 1) + " cm" : "ไม่มีสัญญาณ") + "\n"
         "📌 " + String(zone3Name) + ": " + (b3 > 0 ? String(b3, 1) + " cm" : "ไม่มีสัญญาณ") + "\n"
         "━━━━━━━━━━━━━━━\n"
         "⚙️ ระยะแจ้งเตือน: " + String(DETECT1_DIST_CM) + "/" + String(DETECT2_DIST_CM) + "/" + String(DETECT3_DIST_CM) + " cm\n"
         "⏰ " + getTimestamp());
